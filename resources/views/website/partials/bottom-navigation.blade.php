<div
    ...
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <a href="{{ route('home.index') }}" data-tooltip-target="tooltip-home" type="button"
        ...
        <a href="{{ route('services.index') }}" data-tooltip-target="tooltip-wallet" type="button"
        ...
        <a href="{{ route('home.index') }}" data-tooltip-target="tooltip-settings" type="button"
            class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
