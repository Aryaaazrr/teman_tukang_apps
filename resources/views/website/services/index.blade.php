    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-12">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at TemanTukang we focus on
            ...
            <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3">
                <div
                    class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm hover:border-primary-400 hover:shadow-sm hover:shadow-primary-400 dark:border-gray-700 dark:bg-gray-800">
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="w-full h-full rounded-lg" src="{{ asset('static/website/image/service3.jpg') }}"
                                alt="" />
                        </a>
                    </div>
                    <div class="pt-6">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Professional
                            and Reliable Welding Services</a>
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="w-full h-full rounded-lg" src="{{ asset('static/website/image/service2.jpg') }}"
                                alt="" />
                        </a>
                    </div>
                    ...
                    <div class="pt-6">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Durable
                            Ceiling Solutions for Homes and Offices</a>
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="w-full h-full rounded-lg" src="{{ asset('static/website/image/service1.jpg') }}"
                                alt="" />
                        </a>
                    </div>
                    ...
                    <div class="pt-6">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">High-Quality
                            Light Steel Building Solutions</a>
