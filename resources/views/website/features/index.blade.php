...
@section('content')
    <!-- About Start block -->
    <section class="bg-gray-50 dark:bg-gray-800 md:py-16">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <div class="flex flex-col space-y-4 lg:flex-row lg:justify-center md:space-y-0 md:space-x-4">
                <a href="#"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class=" px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <span class="flex justify-center items-center font-semibold text-center text-gray-400 uppercase">FEATURED
                IN</span>
