<nav class="fixed z-30 w-full bg-white dark:bg-neutral-900">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('static/website/image/logo_default.png') }}" class="h-8 mr-3"
                        alt="FlowBite Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">TemanTukang</span>
                </a>
            </div>
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{ Auth::user()->profile_image }}"
                                alt="user photo">
                        </button>
                    </div>
                    <!-- Dropdown menu -->
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a href="#"
                                    ...
                                    role="menuitem">Setting System</a>
                            </li>
                            <li>
